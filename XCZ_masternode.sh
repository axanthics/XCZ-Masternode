...
COIN_BOOTSTRAP='https://github.com/axanthics/xcz/releases/download/v1.0.0/bootstrap.zip'
...
function important_information() {
 ...
 echo -e "${GREEN}xchainz-cli getmasternodestatus${NC}"
 echo -e "${GREEN}xchainz-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
